...
import { CheckCircle, XCircle, Wrench, ExternalLink, Loader2, Lock } from "lucide-react";
        ...
        >
          <div className="glass rounded-2xl p-8 border border-white/10">
            <div className="text-center mb-6">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-physical-orange/10 flex items-center justify-center">
                <Lock className="w-8 h-8 text-physical-orange" />
              </div>
            ...
            <form onSubmit={handleAuth} className="space-y-4">
              <div>
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-black/40 border border-white/10 text-foreground placeholder:text-text-muted focus:outline-none focus:border-physical-orange/50"
                  autoFocus
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full px-4 py-3 rounded-lg bg-physical-orange/10 border border-physical-orange/30 text-physical-orange font-medium hover:bg-physical-orange/20 transition-all"
              >
                Access Admin Panel
              </button>
            </form>
