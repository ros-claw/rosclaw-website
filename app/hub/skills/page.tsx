...
function SkillCard({ skill, number }: { skill: Skill; number: number }) {
  ...
  const processedSkills = useMemo(() => {
    ...
    return skills
      ...
      .sort((a, b) => {
        ...
        const score = (skill: Skill) => (skill.githubStars || 0) * 10 + (skill.viewsCount || 0) + (skill.robotTypes?.length || 0) * 20 + (skill.dependencies?.length || 0) * 5;
