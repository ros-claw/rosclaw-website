...
// Desktop layout
const desktopNodes: Node[] = Object.freeze([
...
const mobileNodes: Node[] = Object.freeze([
...
function FlowContent() {
  ...
  const nodesToUse = useMemo(() => isMobile ? mobileNodes : desktopNodes, [isMobile]);
  const edgesToUse = useMemo(() => isMobile ? mobileEdges : desktopEdges, [isMobile]);
